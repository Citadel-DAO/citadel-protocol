...
contract CitadelBondDepository is CitadelAccessControlled {
  ...
  function deposit(
    ...
    require(payout >= 10000000, "Bond too small"); // must be > 0.01 CTDL ( underflow protection )
  ...
  /**
   * @notice calculate current ratio of debt to CTDL supply
   * @param _BID uint
