...
contract BondTeller is ITeller, CitadelAccessControlled {
    /* ========== DEPENDENCIES ========== */
    ...
    struct Bond {
        ...
        uint256 payout; // sCTDL remaining to be paid. agnostic balance
    ...
    IERC20 internal immutable CTDL;
    IsCTDL internal immutable sCTDL; // payment token
    ...
    function newBond(
        ...
        CTDL.approve(address(staking), _payout);
    ...
    function getReward() external override {
        ...
        FERs[msg.sender] = 0;
        CTDL.safeTransfer(msg.sender, reward);
    }
    ...
    function pay(address _bonder, uint256 _amount) internal {
        sCTDL.safeTransfer(_bonder, _amount);
    }
    ...
    /**
     * @notice calculate amount of CTDL available for claim for single bond
     * @param _bonder address
    ...
    /**
     * @notice calculate amount of CTDL available for claim for array of bonds
     * @param _bonder address
