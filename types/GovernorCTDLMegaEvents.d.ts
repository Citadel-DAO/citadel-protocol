...
interface GovernorCTDLMegaEventsInterface extends ethers.utils.Interface {
  functions: {};
...
export class GovernorCTDLMegaEvents extends BaseContract {
  ...
  interface: GovernorCTDLMegaEventsInterface;
