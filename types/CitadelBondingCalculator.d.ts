...
interface CitadelBondingCalculatorInterface extends ethers.utils.Interface {
  functions: {
...
export class CitadelBondingCalculator extends BaseContract {
  ...
  interface: CitadelBondingCalculatorInterface;
