...
interface ICitadelAuthorityInterface extends ethers.utils.Interface {
  functions: {
...
export class ICitadelAuthority extends BaseContract {
  ...
  interface: ICitadelAuthorityInterface;
