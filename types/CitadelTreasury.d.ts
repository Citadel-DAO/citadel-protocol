...
interface CitadelTreasuryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "repayDebtWithCTDL(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "repayDebtWithCTDL",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export class CitadelTreasury extends BaseContract {
  ...
  interface: CitadelTreasuryInterface;
