...
import type {
  CitadelAuthority,
  CitadelAuthorityInterface,
} from "../CitadelAuthority";
...
export class CitadelAuthority__factory extends ContractFactory {
  constructor(
  ...
  attach(address: string): CitadelAuthority {
    return super.attach(address) as CitadelAuthority;
  }
  connect(signer: Signer): CitadelAuthority__factory {
    return super.connect(signer) as CitadelAuthority__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): CitadelAuthorityInterface {
    return new utils.Interface(_abi) as CitadelAuthorityInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CitadelAuthority {
    return new Contract(address, _abi, signerOrProvider) as CitadelAuthority;
  }
}
