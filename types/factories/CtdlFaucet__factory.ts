...
import type { CtdlFaucet, CtdlFaucetInterface } from "../CtdlFaucet";
...
export class CtdlFaucet__factory extends ContractFactory {
  constructor(
  ...
  deploy(
    ...
    return super.deploy(_ohm, overrides || {}) as Promise<CtdlFaucet>;
  }
  ...
  attach(address: string): CtdlFaucet {
    return super.attach(address) as CtdlFaucet;
  }
  connect(signer: Signer): CtdlFaucet__factory {
    return super.connect(signer) as CtdlFaucet__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): CtdlFaucetInterface {
    return new utils.Interface(_abi) as CtdlFaucetInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CtdlFaucet {
    return new Contract(address, _abi, signerOrProvider) as CtdlFaucet;
  }
}
