...
interface GovernorCTDLMegaDelegatorInterface extends ethers.utils.Interface {
  functions: {
...
export class GovernorCTDLMegaDelegator extends BaseContract {
  ...
  interface: GovernorCTDLMegaDelegatorInterface;
